...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...TelemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	var err, errs error
	builder.ConnectorGroupbytraceConfNumTraces, err = builder.meter.Int64Gauge(
	...
	builder.ConnectorGroupbytraceEventLatency, err = builder.meter.Int64Histogram(
	...
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceIncompleteReleases, err = builder.meter.Int64Counter(
	...
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceNumEventsInQueue, err = builder.meter.Int64Gauge(
		"otelcol_connector_groupbytrace_num_events_in_queue",
		metric.WithDescription("Number of events currently in the queue"),
		metric.WithUnit("1"),
	)
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceNumTracesInMemory, err = builder.meter.Int64Gauge(
	...
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceSpansReleased, err = builder.meter.Int64Counter(
		"otelcol_connector_groupbytrace_spans_released",
		metric.WithDescription("Spans released to the next consumer"),
		metric.WithUnit("1"),
	)
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceTracesEvicted, err = builder.meter.Int64Counter(
		"otelcol_connector_groupbytrace_traces_evicted",
		metric.WithDescription("Traces evicted from the internal buffer"),
		metric.WithUnit("1"),
	)
	errs = errors.Join(errs, err)
	builder.ConnectorGroupbytraceTracesReleased, err = builder.meter.Int64Counter(
