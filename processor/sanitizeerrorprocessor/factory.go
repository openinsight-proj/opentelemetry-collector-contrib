...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/sanitizeerrorprocessor/internal/metadata"
)

var consumerCapabilities = consumer.Capabilities{MutatesData: false}

// NewFactory returns a new factory for the SanitizeError processor.
...
func createTracesProcessor(
	...
	set.Logger.Info("SanitizeError processor started")
